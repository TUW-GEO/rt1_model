...
Within the RT1-module, linear-combination of volume-scattering phase-functions is performed by the :py:class:`volume.LinCombV` class:
...
Within the RT1-module, linear-combination of BRDF's is performed by the :py:class:`surface.LinCombSRF` class:
